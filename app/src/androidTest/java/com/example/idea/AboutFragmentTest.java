...
public class AboutFragmentTest {
    ...
    public void HomeFragmenttestevents() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.aboutView), withText(" I*d*ea app allows users to save (swipe right) or reject (swipe left) other images, and allows users to accumulate liked designs in the app."),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText(" I*d*ea app allows users to save (swipe right) or reject (swipe left) other images, and allows users to accumulate liked designs in the app.")));
    }
